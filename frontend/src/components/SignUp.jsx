                ...
                <div className={styles.container}>
                    ...
                    <form className={styles.form} onSubmit={handlesubmit1}>
                        ...
                        <div className={styles.field}>
                            ...
                            <input className={styles.input} placeholder='Email' type='text' onChange={onchange3} />
                        </div>

                        <div className={styles.btndiv}>
                            {!error && !loader && <button className={styles.buttons}>Next</button>}
                ...
                <div className={styles.container2}>
                    ...
                    <form className={styles.form} onSubmit={handlesubmit2}>
                        <div className={styles.field}>
                            ...
                            <input className={styles.input} placeholder='OTP' type='number' onChange={onchange4} />
                        </div>

                        <div className={styles.btndiv}>
                            {!error && !loader && <button className={styles.buttons}>Verify</button>}
                            {error && <p className={styles.error}>{error}</p>}
                            {loader &&
                                <div className={styles.loadctn}>
                                    <SyncLoader
