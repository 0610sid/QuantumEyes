    ...
    <div>
        ...
        {show && (
          <div>
            ...
            <button className={styles.button}><img src={close} className={styles.img} alt="Close button"/></button>
            </div>
            <div className={styles.chatcont}>
            <iframe
              allow="microphone;"
              src="https://console.dialogflow.com/api-client/demo/embedded/66986b33-d0f9-42ed-9529-ac19a0566e28"
              style={{ height: "70vh", width: "23vw", border:"none", borderRadius:"4%" , padding:"1%" }}
            />
            </div>
          </div>
        )}
